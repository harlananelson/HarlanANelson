...
(function () {
  ...
  function elevenlabsTranscribe(a16) {
    ...
    if (userKey) {
      ...
      fetch('/.netlify/functions/stt', {
        ...
        body: JSON.stringify({ audio_base64: bufToBase64(wav), language: 'ja' })
  ...
  var shim = {
    lang: 'ja-JP', continuous: false, interimResults: true, maxAlternatives: 1,
