...
3. Iframe `#view-sermon`. Default URL `./live-translator.html?v=23`. If Maat is on the tailnet host with no port, or Settings points Listen at `:8443`, the GPU page is `https://<tailscale-host>:8443/?v=22` (WebSocket same-origin).
